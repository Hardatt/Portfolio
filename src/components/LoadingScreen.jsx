    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0a0f1e] overflow-hidden"
        >
          {/* Orbs */}
          <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-violet-600 rounded-full blur-[130px] opacity-20 animate-float" />
          <div className="absolute bottom-1/4 right-1/4 w-56 h-56 bg-blue-600 rounded-full blur-[100px] opacity-20 animate-float-delay" />
          ...
          >
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-600 to-blue-600 flex items-center justify-center shadow-glow-v">
            ...
            <motion.div
              ...
              style={{ background: 'linear-gradient(white,white) padding-box, conic-gradient(from 0deg, #7c3aed, #2563eb, transparent, #7c3aed) border-box' }}
            />
          </motion.div>
